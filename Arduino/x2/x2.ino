...
#define LINE_TOKEN "gvKgiAZZDnhLieAZSreheSwP7BTRToA6s3AkSbg8Rft"  //"fNq6PhPZWDVlYrA5GpfLhyXXHAcD3yw7ueuU4lAEebb"  //--------------------------------
...
void loop() {
  ...
  float humid = dht.readHumidity(); //dht.getHumidity();
  float temp = dht.readTemperature(); //dht.getTemperature();
