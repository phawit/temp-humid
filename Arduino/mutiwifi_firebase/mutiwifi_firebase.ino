...
//     pubLCD();
     ...
     //fake-------------------------- 
     Firebase.setFloat("id/A01/humid", humid+0.02);
     Firebase.setFloat("id/A01/temp", temp-0.03);
     Firebase.setFloat("id/A01/hic", hic);
     Firebase.setString("id/A01/flag", flag);
     Firebase.setString("id/A01/time", NowString());
     Firebase.setString("id/A01/date", NowString2());

     Firebase.setFloat("id/A02/humid", humid+0.01);
     Firebase.setFloat("id/A02/temp", temp-0.01);
     Firebase.setFloat("id/A02/hic", hic);
     Firebase.setString("id/A02/flag", flag);
     Firebase.setString("id/A02/time", NowString());
     Firebase.setString("id/A02/date", NowString2());

     Firebase.setFloat("id/A04/humid", humid-0.01);
     Firebase.setFloat("id/A04/temp", temp);
     Firebase.setFloat("id/A04/hic", hic);
     Firebase.setString("id/A04/flag", flag);
